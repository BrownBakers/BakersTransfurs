...
import net.kjentytek303.additional_transfurs.client.renderer.LatexCheetahMaleRenderer;
import net.kjentytek303.additional_transfurs.client.renderer.LatexFoxRenderer;

import net.kjentytek303.additional_transfurs.client.renderer.LatexCheetahFemaleRenderer;
